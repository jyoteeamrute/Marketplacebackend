...
print("category is runnning scritp>>>>>>>>>>>>>>>>>>>>>>>>s")
...
categories_data = [
        {
            ...
            "order_by": 1,
            "subcategories": [
                {"name": "Fast Food", "description": "Default description", "order_by": 1, "machine_name": "Fast Food", "subcategoriesImage": "categories_image/2 Travel.jpg", "type": "Quick Bites"},
                {"name": "Gourmet Restaurants", "description": "Default description", "order_by": 8, "machine_name": "Gourmet Restaurants", "subcategoriesImage": "categories_image/2 Travel.jpg", "type": "Fine Dining"},
                ...
                {"name": "Hotel Dining", "description": "Default description", "order_by": 7, "machine_name": "Hotel Dining", "subcategoriesImage": "staticfiles/subcategoryimg/01restauration/04 Hotel Dining.jpeg", "type": "Luxury"},
                ...
                {"name": "Themed Bars", "description": "Default description", "order_by": 4, "machine_name": "Themed Bars", "subcategoriesImage": "staticfiles/subcategoryimg/01restauration/07 Themed Bars.jpeg", "type": "Bars"},
                {"name": "Rooftop", "description": "Default description", "order_by": 2, "machine_name": "Rooftop", "subcategoriesImage": "staticfiles/subcategoryimg/01restauration/08 Rooftop.jpeg", "type": "Outdoor"},
            ]
        },
        
    {
        ...
        "machine_name": "Travel",
        "description": "test",
        "categoriesImage": "categories_image/2 Travel.jpg",
        "type": "Accommodation",
        "distance": None,
        "onSite": False,
        "clickCollect": False,
    ...
    },
    {
        ...
        "description": "test",
        "categoriesImage": "categories_image/3 Esthetique.jpg",
    ...
    },
    {
        ...
        "description": "test",
        "categoriesImage": "categories_image/4 Relexation.jpg",
    ...
    
    {
        ...
        "description": "test",
        "categoriesImage": "categories_image/5 Art & Culture.jpg",
    ...
    },
    {
        ...
        "machine_name": "Music",
        "description": "test",
        "categoriesImage": "categories_image/6 Music.jpg",
        "type": "Entertainment",
        "distance": None,
        "onSite": False,
        "clickCollect": False,
        ...
        
    {
        ...
        "description": "test",
        "categoriesImage": "categories_image/7 Experiences.jpg",
        "type": "Activities",
        "distance": None,
        "onSite": False,  
        "clickCollect": False,
        ...
        "subcategories": [
            ...
            {"name": "Experiences", "description": "Unique and immersive activities", "order_by": 10, "machine_name": "Experiences", "subcategoriesImage": "staticfiles/subcategoryimg/07experiences/07 Experiences.jpeg", "type": "Adventure"},
            ...
            {"name": "Nautical activity", "description": "Water-based sports and adventures", "order_by": 7, "machine_name": "Nautical activity", "subcategoriesImage": "staticfiles/subcategoryimg/07experiences/10 Nautical activity.jpeg", "type": "Water Sports"}
        ]
    },
    {
        ...
        "description": "test",
        "categoriesImage": "categories_image/8 Product Purchase.jpg",
        "type": "Shopping",
        "distance": None,
        "onSite": False,  
        "clickCollect": False,
...
def custom_slugify(value):
    value = re.sub(r'[^\w\s]', '', value)  # keep alphanumerics, underscores, and spaces
    value = re.sub(r'\s+', '_', value.strip())  # convert spaces to underscores
    return value.lower()


def format_subcategory_image_url(image_url, name):
    if not image_url:
        return ""
    
    image_url = unquote(image_url)  # Decode any encoded URL
    expected_base_url = "https://markerplacemobileapp.s3.us-east-1.amazonaws.com/uploads/"
    
    if image_url.startswith(expected_base_url):
        return image_url
    
    formatted_name = custom_slugify(name)
    unique_suffix = "ysrmUu6"  # Example unique identifier
    extension = image_url.split('.')[-1]
    
    return f"{expected_base_url}{formatted_name}__{unique_suffix}.{extension}"


for category_data in categories_data:
    category_data["slug"] = slugify(category_data["name"])
    category_data.setdefault("type", "General")
    ...
    for subcategory_data in category_data["subcategories"]:
        subcategory_data["slug"] = slugify(subcategory_data["name"])
        subcategory_data.setdefault("type", "General")
        
        # Ensure the image URL is correctly formatted
        formatted_image_url = format_subcategory_image_url(
            subcategory_data.get("subcategoriesImage", ""), subcategory_data["name"]
        )
        ...
        subcategory, created = Subcategory.objects.update_or_create(
            ...
            defaults={
                ...
                "subcategoriesImage": formatted_image_url,
                "distance": None,
                "clickCollect": False,
                "halal": False,
                "handicapped": False,
